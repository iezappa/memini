...
/// Android's automatic backup would copy the Drift database — every entry and
/// the TMDB/RAWG keys kept in the local settings — into the user's Google
/// account. PRIVACY.md promises the data stays on the device, so the app opts
/// out, and this test keeps the opt-out from being dropped by a Flutter
/// template update.
void main() {
